...
class GetAuthResponse extends Command
{
    protected $signature = 'GetAuthResponse';
    ...
    {
        $bookResults = DB::table('itours')->where('message', 'like', '%Supplier Response - IToursSignIn%')->pluck('info')->toArray();
        $data = [];
        $resultAll = [];
