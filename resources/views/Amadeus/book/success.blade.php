                ...
                <AirReservation>
                    <AirItinerary>
                        <OriginDestinationOptions>
                            @foreach($information['option'] as $key=>$option)
                    ...
                    <PriceInfo>
                        <ItinTotalFare>
                            ...
                            <BaseFare Currency="{{$information['pricing']['curency']}}" Amount="{{$information['pricing']['totalbasefare']}}" />
                            <MarkupFare Amount="0" />
                            <TotalFare Amount="{{$information['pricing']['totalTotalefare']}}" Currency="{{$information['pricing']['curency']}}" />
                            <TotalAmountInTicketingCurrency Amount="{{$information['pricing']['totalTotalefare']}}" Currency="{{$information['pricing']['curency']}}" />
                        </ItinTotalFare>
                        <PTC_FareBreakdowns>
                            @if(!empty($countMembers['adult']))
                            <PTC_FareBreakdown>
                                <PassengerTypeQuantity Code="ADT" Quantity="{{$countMembers['adult']}}" />
                                <PassengerFare>
                                    <BaseFare Amount="{{$information['pricing']['adultBaseFare']}}" />
                                    <MarkupFare Amount="0" />
                                    <Taxes>
                                        <Tax Amount="{{$information['pricing']['taxFare']}}" />
                                    </Taxes>
                                    <TotalFare Amount="{{$information['pricing']['adultTotaleFare']}}" />
                                </PassengerFare>
                                <TicketDesignators>
                            ...
                            @if(!empty($countMembers['child']))
                            <PTC_FareBreakdown>
                                <PassengerTypeQuantity Code="CHD" Quantity="{{$countMembers['child']}}" />
                                <PassengerFare>
                                    <BaseFare Amount="{{$information['pricing']['childBaseFare']}}" />
                                    <MarkupFare Amount="0" />
                                    <Taxes>
                                        <Tax Amount="{{$information['pricing']['taxFare']}}" />
                                    </Taxes>
                                    <TotalFare Amount="{{$information['pricing']['childTotaleFare']}}" />
                                </PassengerFare>
                            ...
                            @if(!empty($countMembers['infant']))
                            <PTC_FareBreakdown>
                                <PassengerTypeQuantity Code="INF" Quantity="$countMembers['infant']" />
                                <PassengerFare>
                                    <BaseFare Amount="{{$information['pricing']['infantBaseFare']}}" />
                                    <MarkupFare Amount="0" />
                                    <Taxes>
                                        <Tax Amount="{{$information['pricing']['taxFare']}}" />
                                    </Taxes>
                                    <TotalFare Amount="{{$information['pricing']['infantTotalFare']}}" />
                                </PassengerFare>
                                <TicketDesignators>
                                    <TicketDesignator TicketDesignatorCode="70|PEN" TicketDesignatorExtension="TICKETS ARE NON-REFUNDABLE|" />
                                    <TicketDesignator TicketDesignatorCode="40|LTD" TicketDesignatorExtension="LAST TKT DTE|04OCT21| - SEE ADV PURCHASE|" />
                    ...
                    <TravelerInfo>
                        ...
                        <AirTraveler PassengerTypeCode="{{$info['type']}}">
                        ...
                        @endforeach
                        @else
                        <AirTraveler PassengerTypeCode="{{$passInfo['type']}}">
                            <NumberOfBaggages>0</NumberOfBaggages>
                            <NumberOfBaggages1>0</NumberOfBaggages1>
                            <HandLuggages>0</HandLuggages>
                            <HandLuggages1>0</HandLuggages1>
                            <PersonName>
                                <NamePrefix>{{$passInfo['namePrefix']}}</NamePrefix>
                                <GivenName>{{$passInfo['firstName']}}</GivenName>
                                <Surname>{{$passInfo['surname']}}</Surname>
                            </PersonName>
                            <Email />
                            <Document DocIssueLocation="" DocType="DOCO" DocIssueCountry="" DocVisaExpirationDate="0001-01-01" />
                            <Document DocType="DOCS" DocIssueCountry="" DocVisaExpirationDate="0001-01-01" />
                            <Document DocType="DOCA" DocIssueCountry="" DocVisaExpirationDate="0001-01-01" />
                            <Document DocType="DOCA2" DocIssueCountry="" DocVisaExpirationDate="0001-01-01" />
                            <BirthDate>{{$passInfo['birthday']}}</BirthDate>
                        </AirTraveler>
                        @endif
                    </TravelerInfo>
                    <Fulfillment>
                    ...
                    <Ticketing TicketTimeLimit="{{$information['timeTiket']}}" TicketType="BookingOnly" />
                    <BookingReferenceID Type="F" ID_Context="{{$information['contexId']}}" />
                    <FlightRulePenalties>
                        <FareRuleInfo>
